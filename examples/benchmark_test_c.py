...
from glassboxml.metrics._classification import accuracy_score
from glassboxml.datasets._generators import make_moons
...
def main():
    ...
    models = {
        ...
        "Linear SVM (Hard Margin)": SVM(lambda_param=0.001, n_iters=500),
