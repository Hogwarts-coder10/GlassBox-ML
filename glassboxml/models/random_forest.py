...
from glassboxml.models.decision_tree import DecisionTreeClassifier
from glassboxml.models.decision_tree import DecisionTreeRegressor
...
class RandomForestClassifier(GlassBoxModel):
    ...
    def fit(self, X, y):
        ...
        print(f"Planting a forest of {self.n_trees} trees...")
        for i in range(self.n_trees):
            ...
            # BOOTSTRAPPING: Pick random rows from the dataset (with replacement)
            # This ensures every tree looks at a slightly different version of the world!
        ...
        self.is_fitted = True
        self.training_error = "N/A (Ensemble Voting)"
